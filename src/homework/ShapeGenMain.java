...
//		ArrayList<GenShape> arr = new ArrayList<GenShape>();
		TreeSet<GenShape> arr = new TreeSet<GenShape>(new Comparator<GenShape>() {

//			@Override
//			public int compare(Object o1, Object o2) {
//				GenRectangle me = (GenRectangle)o1;
//				GenCircle you = (GenCircle)o2;
//				
//				int res = me.area - you.area;
//				if(res==0) {
...
//				System.out.println("@@"+res);
		...
		arr.add(new GenRectangle(5, 6)); //30
		arr.add(new GenCircle(5)); //
		arr.add(new GenRectangle(10, 6)); //60
		arr.add(new GenCircle(8));
		arr.add(new GenCircle(10));
		arr.add(new GenRectangle(8, 7)); //56
